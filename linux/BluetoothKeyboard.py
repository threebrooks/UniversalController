...
keyMap = {
        ...
        "KEYCODE_AT" : [uinput.KEY_LEFTSHIFT, uinput.KEY_2],
        ...
        "KEYCODE_CTRL_LEFT" : [uinput.KEY_LEFTCTRL],
        "KEYCODE_DEL" : [uinput.KEY_BACKSPACE],
        ...
        "KEYCODE_EQUALS" : [uinput.KEY_EQUAL],
        "KEYCODE_ESCAPE" : [uinput.KEY_ESC],
        ...
        "KEYCODE_PAGE_DOWN" : [uinput.KEY_PAGEDOWN],
        "KEYCODE_PAGE_UP" : [uinput.KEY_PAGEUP],
        "KEYCODE_PERIOD" : [uinput.KEY_DOT],
        "KEYCODE_PLUS" : [uinput.KEY_LEFTSHIFT, uinput.KEY_EQUAL],
        "KEYCODE_SEMICOLON" : [uinput.KEY_SEMICOLON],
        "KEYCODE_SHIFT_LEFT" : [uinput.KEY_LEFTSHIFT],
        "KEYCODE_SHIFT_RIGHT" : [uinput.KEY_RIGHTSHIFT],
        "KEYCODE_SLASH" : [uinput.KEY_SLASH],
        "KEYCODE_SPACE" : [uinput.KEY_SPACE],
        "KEYCODE_STAR" : [uinput.KEY_LEFTSHIFT, uinput.KEY_8],
        "KEYCODE_TAB" : [uinput.KEY_TAB],
        }

def getUsedKeys(dict):
  outDict = {}
  for key in dict.keys():
    for el in dict[key]:
      outDict[el] = 1 
  return list(outDict.keys())


log = open("/var/log/bluetoothkeyboard.log","w")

device = uinput.Device(getUsedKeys(keyMap))
