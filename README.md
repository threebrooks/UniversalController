...
8. ColecoVision
<img src="https://github.com/threebrooks/UniversalController/blob/master/images/colecovision.png" alt="ColecoVision" width="300px"/>
...
* At the top right, tap the Settings icon, this will slide in the selection for both Bluetooth and the Controller. Select your RPi ("retropie") from the Bluetooth menu
